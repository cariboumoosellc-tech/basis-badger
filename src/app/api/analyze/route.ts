...
export async function POST(req: Request) {
  try {
    ...
    const prompt = `
      Act as an expert Merchant Statement Auditor.
      Analyze this image/document.
			
      Extract or Estimate:
      1. "totalFees": Total amount charged/debited.
      2. "totalVolume": Total sales volume.
      3. "junkFees": Sum of suspicious fees (PCI, Non-Compliance, Annual, Markups).
      4. "redFlags": List names of bad fees.
