...
// Fallback: If data is missing (0), use a 'safe' estimate so it never looks broken
// But we prioritize the real props passed in.
...
return (
  ...
  {/* 1. The Blurred Background (The 'Tease') */}
  <div className="absolute inset-0 filter blur-xl opacity-30 pointer-events-none p-8">
  ...
  {/* 2. The "Lockdown" Card (The Real Data) */}
  <div className="absolute inset-0 flex flex-col items-center justify-center z-10 p-6">
    <motion.div 
      initial={{ scale: 0.9, opacity: 0 }}
      animate={{ scale: 1, opacity: 1 }}
      className="bg-zinc-950/90 border border-amber-500/30 backdrop-blur-md p-8 rounded-2xl shadow-2xl max-w-md w-full text-center"
    >
